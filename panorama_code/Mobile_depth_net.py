...
class Mobile_depth_net(tf.keras.Model):
    def __init__(self, opt):
        super(Mobile_depth_net, self).__init__()
...
class Mobile_pose_net(tf.keras.Model):
    def __init__(self, opt):
        super(Mobile_pose_net, self).__init__()
...
class depth_ego_net_Mobile(tf.keras.Model):
    def __init__(self, opt):
        super(depth_ego_net_Mobile, self).__init__()
        self.flags = opt
        ...
        self.depth_net = Mobile_depth_net(opt)
        self.pose_net = Mobile_pose_net(opt)
