...
RUN sudo dpkg -i cuda-repo-ubuntu1804_10.1.243-1_amd64.deb
...
RUN sudo apt install ./nvidia-machine-learning-repo-ubuntu1804_1.0.0-1_amd64.deb
RUN sudo apt-get update

# Install NVIDIA driver
RUN sudo apt-get install --no-install-recommends nvidia-driver-430
